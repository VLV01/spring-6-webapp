package vlv.springframework.spring6webapp.bootstrap;
...
import vlv.springframework.spring6webapp.repositories.PublisherRepository;
...
public class BootstrapData implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        publisher.setAddress("Jhonson's street");
        publisher.setCity("Columbus");
        publisher.setState("Ohio");
        publisher.setZipCode("43004");
